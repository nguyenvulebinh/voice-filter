...
class ESPnetEnhancementModel(AbsESPnetModel):
    ...
    def forward_enhance(
        ...
        if self.mask_module is None:
            feature_pre, flens, others = self.separator(feature_mix, speaker_embed, flens, additional)
        else:
