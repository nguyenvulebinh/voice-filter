...
from .espnet_enh_model import ESPnetEnhancementModel
...
from src.net.rnn_separator_voice_filter import RNNSeparatorVoiceFilter
from src.net.tcn_separator_voice_filter import TCNSeparatorVoiceFilter
from src.net.conformer_separator_voice_filter import ConformerSeparatorVoiceFilter
...
separator_choices = ClassChoices(
    ...
    classes=dict(
        ...
        conformer_voice_filter=ConformerSeparatorVoiceFilter,
        dan=DANSeparator,
        ...
        rnn=RNNSeparator,
        rnn_voice_filter=RNNSeparatorVoiceFilter,
        skim=SkiMSeparator,
        svoice=SVoiceSeparator,
        tcn=TCNSeparator,
        tcn_voice_filter=TCNSeparatorVoiceFilter,
...
class EnhancementTask(AbsTask):
    ...
    def build_model(cls, args: argparse.Namespace) -> ESPnetEnhancementModel:
        ...
        separator = separator_choices.get_class(args.separator)(
            encoder.output_dim + args.xvector_emb_dim, 
